...
<head>
	...
	<link href="{{ asset('frontend/js/lightslider/lightslider.css') }}" rel="stylesheet">
	...
	<script type="text/javascript" src="{{ asset('frontend/js/lightslider/lightslider.js') }}"></script>
								...
								<ul class="top-link list-inline">
									...
									<li class="form-group languages-block ">
										<form action="index.html" method="post" enctype="multipart/form-data" id="bt-language">
											<a class="btn btn-xs dropdown-toggle" data-toggle="dropdown">
												<img src="{{ asset('frontend/image/demo/flags/gb.png') }}" alt="English" title="English">
												<span class="">English</span>
												<span class="fa fa-angle-down"></span>
											</a>
											<ul class="dropdown-menu">
												<li><a href="index.html"><img class="image_flag" src="{{ asset('frontend/image/demo/flags/gb.png') }}" alt="English" title="English" /> English </a></li>
												<li> <a href="index.html"> <img class="image_flag" src="{{ asset('frontend/image/demo/flags/lb.png') }}" alt="Arabic" title="Arabic" /> Arabic </a> </li>
											</ul>
										</form>
									</li>
								</ul>
				...
				<div class="container">
					<div class="row">
						...
						<div class="navbar-logo col-md-3 col-sm-4 col-xs-10">
						   <a href="index.html"><img src="{{ asset('frontend/image/demo/logos/theme_logo.png') }}" title="Your Store" alt="Your Store" /></a>
						</div>
												...
												<div class="container">
													<ul class="megamenu " data-transition="slide" data-animationtime="250">
																	...
																	<div class="row">
																		<div class="col-md-3">
																			<a href="index.html" class="image-link"> 
																				<span class="thumbnail">
																					<img class="img-responsive img-border" src="{{ asset('frontend/image/demo/menu/home-1.jpg') }}" alt="">
																		...
																		<div class="col-md-3">
																			<a href="home2.html" class="image-link"> 
																				<span class="thumbnail">
																					<img class="img-responsive img-border" src="{{ asset('frontend/image/demo/menu/home-2.jpg') }}" alt="">
																					<span class="btn btn-default">Read More</span>
																				</span> 
																		...
																		<div class="col-md-3">
																			<a href="home3.html" class="image-link"> 
																				<span class="thumbnail">
																					<img class="img-responsive img-border" src="{{ asset('frontend/image/demo/menu/home-3.jpg') }}" alt="">
																					<span class="btn btn-default">Read More</span>
																				</span> 
																		...
																		<div class="col-md-3">
																			<a href="home4.html" class="image-link"> 
																				<span class="thumbnail">
																					<img class="img-responsive img-border" src="{{ asset('frontend/image/demo/menu/home-4.jpg') }}" alt="">
																					<span class="btn btn-default">Read More</span>
																				</span> 
																		...
																		<div class="col-md-3">
																			<a href="home5.html" class="image-link"> 
																				<span class="thumbnail">
																					<img class="img-responsive img-border" src="{{ asset('frontend/image/demo/menu/home-5.jpg') }}" alt="">
																					<span class="btn btn-default">Read More</span>
																				</span> 
																		...
																		<div class="col-md-3">
																			<a href="home6.html" class="image-link"> 
																				<span class="thumbnail">
																					<img class="img-responsive img-border" src="{{ asset('frontend/image/demo/menu/home-6.jpg') }}" alt="">
																					<span class="btn btn-default">Read More</span>
																				</span> 
																		...
																		<div class="col-md-3">
																			<a href="home7.html" class="image-link"> 
																				<span class="thumbnail">
																					<img class="img-responsive img-border" src="{{ asset('frontend/image/demo/menu/home-7.jpg') }}" alt="">
																					<span class="btn btn-default">Read More</span>
																				</span> 
																		...
																		<div class="col-md-3">
																			<a href="home8.html" class="image-link"> 
																				<span class="thumbnail">
																					<img class="img-responsive img-border" src="{{ asset('frontend/image/demo/menu/home-8.jpg') }}" alt="">
																					<span class="btn btn-default">Read More</span>
																				</span> 
																		...
																		<div class="col-md-3">
																			<a href="home9.html" class="image-link"> 
																				<span class="thumbnail">
																					<img class="img-responsive img-border" src="{{ asset('frontend/image/demo/menu/home-9.jpg') }}" alt="">
																					<span class="btn btn-default">Read More</span>
																				</span> 
																		...
																		<div class="col-md-3">
																			<a href="home10.html" class="image-link"> 
																				<span class="thumbnail">
																					<img class="img-responsive img-border" src="{{ asset('frontend/image/demo/menu/home-10.jpg') }}" alt="">
																					<span class="btn btn-default">Read More</span>
																				</span> 
																		...
																		<div class="col-md-3">
																			<a href="#" class="image-link"> 
																				<span class="thumbnail">
																					<img class="img-responsive img-border" src="{{ asset('frontend/image/demo/menu/home-11.jpg') }}" alt="">
																					<span class="btn btn-default">Read More</span>
																				</span> 
																		...
																		<div class="col-md-3">
																			<a href="#" class="image-link"> 
																				<span class="thumbnail">
																					<img class="img-responsive img-border" src="{{ asset('frontend/image/demo/menu/home-12.jpg') }}" alt="">
																					<span class="btn btn-default">Read More</span>
																				</span> 
																	...
																	<div class="row">
																		...
																		<div class="col-md-3">
																			<div class="column">
																				...
																				<div>
																					<ul class="row-list">
																						<li><a href="{{ url('cart') }}">Shopping Cart Page</a></li>
																			...
																			<div class="column">
																				...
																				<div>
																					<ul class="row-list">
																						...
																						<li><a href="{{ url('order_info') }}">Order History</a></li>
																						<li><a href="{{ url('order_info') }}">Order Information</a></li>
														...
														<li class="with-sub-menu hover">
															<p class="close-menu"></p>
															<a href="#" class="clearfix">
																<strong><img src="{{ asset('frontend/image/demo/menu/hot-icon.png') }}" alt="">Pages</strong>
																<b class="caret"></b>
															</a>
														...
														<li class="with-sub-menu hover">
															<p class="close-menu"></p>
															<a href="#" class="clearfix">
																<strong><img src="{{ asset('frontend/image/demo/menu/new-icon.png') }}" alt="">Categories</strong>
																		...
																		<div class="col-sm-12">
																			<div class="row">
																				<div class="col-md-3 img img1">
																					<a href="#"><img src="{{ asset('frontend/image/demo/cms/img1.jpg') }}" alt="banner1"></a>
																				</div>
																				<div class="col-md-3 img img2">
																					<a href="#"><img src="{{ asset('frontend/image/demo/cms/img2.jpg') }}" alt="banner2"></a>
																				</div>
																				<div class="col-md-3 img img3">
																					<a href="#"><img src="{{ asset('frontend/image/demo/cms/img3.jpg') }}" alt="banner3"></a>
																				</div>
																				<div class="col-md-3 img img4">
																					<a href="#"><img src="{{ asset('frontend/image/demo/cms/img4.jpg') }}" alt="banner4"></a>
																				</div>
																			</div>
																		</div>
																	</div>
																	...
																	<div class="row">
																		...
																		<div class="col-md-4">
																			...
																			<div class="col-sm-12 list-product">
																				<div class="product-thumb">
																					<div class="image pull-left">
																						<a href="#"><img src="{{ asset('frontend/image/demo/shop/product/35.jpg') }}" width="80" alt="Filet Mign" title="Filet Mign" class="img-responsive"></a>
																					</div>
																					<div class="caption">
																			...
																			<div class="col-sm-12 list-product">
																				<div class="product-thumb">
																					<div class="image pull-left">
																						<a href="#"><img src="{{ asset('frontend/image/demo/shop/product/W1.jpg') }}" width="80" alt="Dail Lulpa" title="Dail Lulpa" class="img-responsive"></a>
																					</div>
																					<div class="caption">
																			...
																			<div class="col-sm-12 list-product">
																				<div class="product-thumb">
																					<div class="image pull-left">
																						<a href="#"><img src="{{ asset('frontend/image/demo/shop/product/141.jpg') }}" width="80" alt="Canon EOS 5D" title="Canon EOS 5D" class="img-responsive"></a>
																					</div>
																					<div class="caption">
														...
														<div class="container">
															<ul class="megamenu">
																...
																<li class="item-vertical style1 with-sub-menu hover">
																	...
																	<a href="{{ url('view-category/'. $item->id ) }}" class="clearfix">
																		<strong>
                    ...
                    <div class="module ">
                        ...
                        <div class="modcontent">
                            ...
                            <ul class="payment-method">
                                <li><a title="Payment Method" href="#"><img src="{{ asset('frontend/image/demo/cms/payment/payment-1.png') }}" alt="Payment"></a></li>
                                <li><a title="Payment Method" href="#"><img src="{{ asset('frontend/image/demo/cms/payment/payment-2.png') }}" alt="Payment"></a></li>
                                <li><a title="Payment Method" href="#"><img src="{{ asset('frontend/image/demo/cms/payment/payment-3.png') }}" alt="Payment"></a></li>
                                <li><a title="Payment Method" href="#"><img src="{{ asset('frontend/image/demo/cms/payment/payment-4.png') }}" alt="Payment"></a></li>
                                <li><a title="Payment Method" href="#"><img src="{{ asset('frontend/image/demo/cms/payment/payment-5.png') }}" alt="Payment"></a></li>
                            </ul>
                        </div>
                    </div>				
                </div>
...
<div id="sp-cpanel_settings">
    ...
    <div class="panel-group">
        ...
        <div class="group-pattern">
            <div data-pattern="28"  class="img-pattern"><img src="{{ asset('frontend/image/theme/patterns/28.png') }}" alt="pattern 28"></div>
            <div data-pattern="29"  class="img-pattern"><img src="{{ asset('frontend/image/theme/patterns/29.png') }}" alt="pattern 29"></div>
            <div data-pattern="30"  class="img-pattern"><img src="{{ asset('frontend/image/theme/patterns/30.png') }}" alt="pattern 30"></div>
            <div data-pattern="31"  class="img-pattern"><img src="{{ asset('frontend/image/theme/patterns/31.png') }}" alt="pattern 31"></div>
            <div data-pattern="32"  class="img-pattern"><img src="{{ asset('frontend/image/theme/patterns/32.png') }}" alt="pattern 32"></div>
            <div data-pattern="33"  class="img-pattern"><img src="{{ asset('frontend/image/theme/patterns/33.png') }}" alt="pattern 33"></div>
            <div data-pattern="34"  class="img-pattern"><img src="{{ asset('frontend/image/theme/patterns/34.png') }}" alt="pattern 34"></div>
            <div data-pattern="35"  class="img-pattern"><img src="{{ asset('frontend/image/theme/patterns/35.png') }}" alt="pattern 35"></div>
            <div data-pattern="36"  class="img-pattern"><img src="{{ asset('frontend/image/theme/patterns/36.png') }}" alt="pattern 36"></div>
            <div data-pattern="37"  class="img-pattern"><img src="{{ asset('frontend/image/theme/patterns/37.png') }}" alt="pattern 37"></div>
            <div data-pattern="38"  class="img-pattern"><img src="{{ asset('frontend/image/theme/patterns/38.png') }}" alt="pattern 38"></div>
            <div data-pattern="39"  class="img-pattern"><img src="{{ asset('frontend/image/theme/patterns/39.png') }}" alt="pattern 39"></div>
            <div data-pattern="40"  class="img-pattern"><img src="{{ asset('frontend/image/theme/patterns/40.png') }}" alt="pattern 40"></div>
            <div data-pattern="41"  class="img-pattern"><img src="{{ asset('frontend/image/theme/patterns/41.png') }}" alt="pattern 41"></div>
            <div data-pattern="42"  class="img-pattern"><img src="{{ asset('frontend/image/theme/patterns/42.png') }}" alt="pattern 42"></div>
            <div data-pattern="43"  class="img-pattern"><img src="{{ asset('frontend/image/theme/patterns/43.png') }}" alt="pattern 43"></div>
            <div data-pattern="44"  class="img-pattern"><img src="{{ asset('frontend/image/theme/patterns/44.png') }}" alt="pattern 44"></div>
            <div data-pattern="45"  class="img-pattern"><img src="{{ asset('frontend/image/theme/patterns/45.png') }}" alt="pattern 45"></div>
        </div>
...
<script type="text/javascript" src="{{ asset('frontend/js/themejs/cpanel.js') }}"></script>	<!-- //Cpanel Block -->
