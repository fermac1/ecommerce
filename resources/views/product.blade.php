				...
				<aside class="col-sm-4 col-md-3" id="column-left">
					...
					<div class="module latest-product titleLine">
					   ...
					   <div class="modcontent ">
							<div class="product-latest-item">
								<div class="media">
								   <div class="media-left">
									  <a href="#"><img src="{{ asset('frontend/image/demo/shop/product/m1.jpg') }}" alt="Cisi Chicken" title="Cisi Chicken" class="img-responsive" style="width: 90px; height: 90px;"></a>
								   </div>
							...
							<div class="product-latest-item">
								<div class="media">
								   <div class="media-left">
									  <a href="#"><img src="{{ asset('frontend/image/demo/shop/product/m2.jpg') }}"alt="Cisi Chicken" title="Cisi Chicken" class="img-responsive" style="width: 90px; height: 90px;"></a>
								   </div>
								   <div class="media-body">
									  <div class="caption">
							...
							<div class="product-latest-item">
								<div class="media">
								   <div class="media-left">
									  <a href="#"><img src="{{ asset('frontend/image/demo/shop/product/18.jpg') }}"alt="Cisi Chicken" title="Cisi Chicken" class="img-responsive" style="width: 90px; height: 90px;"></a>
								   </div>
								   <div class="media-body">
									  <div class="caption">
					...
					<div class="module">
						<div class="modcontent clearfix">
							<div class="banners">
								<div>
									<a href="#"><img src="{{ asset('frontend/image/demo/cms/left-image-static.png') }}" alt="left-image"></a>
								</div>
							</div>
				...
				<div id="content" class="col-md-9 col-sm-8">
					<div class="products-category">
						<div class="category-derc form-group">
							<div class="row">
								<div class="col-sm-12">
								<p><img src="{{ asset('frontend/image/demo/shop/category/electronic-cat.png') }}"alt="Apple Cinema 30&quot;"><br></p>
						...
						<div class="refine-search form-group">
							<div class="row">
								<div class="form-group col-md-15 col-sm-4 col-xs-12 ">
									<a href="#" class="thumbnail"><img src="{{ asset('frontend/image/demo/shop/product/m2.jpg') }}"alt="Car Alarms and Security"></a> <a href="#">Car Alarms and Security</a>			
								</div>
								<div class="form-group col-md-15 col-sm-4 col-xs-12 ">
									<a href="#" class="thumbnail"><img src="{{ asset('frontend/image/demo/shop/product/e2.jpg') }}"alt="Car Audio &amp; Speakers"></a> <a href="#">Car Audio &amp; Speakers</a>			
								</div>
								<div class="form-group col-md-15 col-sm-4 col-xs-12 ">
									<a href="#" class="thumbnail"><img src="{{ asset('frontend/image/demo/shop/product/10.jpg') }}"alt="Gadgets &amp; Auto Parts">	</a> <a href="#">Gadgets &amp; Auto Parts</a>			
								</div>
								<div class="form-group col-md-15 col-sm-4 col-xs-12 ">
									<a href="#" class="thumbnail"><img src="{{ asset('frontend/image/demo/shop/product/18.jpg') }}"alt="More Car Accessories">	</a> <a href="#">More Car Accessories</a>			
								</div>
								<div class="form-group col-md-15 col-sm-4 col-xs-12 ">
									<a href="#" class="thumbnail"><img src="{{ asset('frontend/image/demo/shop/product/19.jpg') }}"alt="More Car Accessories">	</a> <a href="#">More Car Accessories</a>			
								</div>
							</div>
						</div>
						<!---//Subcategories - -->
								...
								<div class="product-item-container">
									<div class="left-block">
										...
										<div class="product-image-container lazy second_img ">
											...
											<img src="{{ asset('frontend/image/demo/shop/product/'. $product->image1) }}" alt="Apple Cinema 30&quot;" class="img-1 img-responsive" />
											<img src="{{ asset('frontend/image/demo/shop/product/'. $product->image2) }}" alt="Apple Cinema 30&quot;" class="img-2 img-responsive" />

											@if ($product->qty > 0)
											<span class="label label-sale">{{ $product->label }}</span>
									
											@else
											<span class="label label-sale">Out of Stock</span>
											@endif
										</div>
										</a>
									</div>
									...
									<div class="button-group">
										...
										<button class="wishlist btn-button addToWishlist" type="button" data-toggle="tooltip" title="Add to Wish List" ><i class="fa fa-heart"></i></button>

										@if ($product->qty > 0)
										<button class="addToCart add-cart" type="button" data-toggle="tooltip" title="Add to Cart" onclick="cart.add('42', '1');"><i class="fa fa-shopping-cart"></i> <span class="hidden-xs name-cart">Add to Cart</span></button>
										@endif
...
<script>
			$(document).ready(function() {
				...
				var product_id = $(this).closest('.product-item-container').find('.prod_id').val();
				var product_qty = $(this).closest('.product-item-container').find('.qty-input').val();
